return {
  ...
  config = function(_, opts)
    ...
    vim.keymap.set('n', '<leader>wS', '<cmd>AutoSession save<CR>', { desc = '[W]orkspace [S]ession save' })
    vim.keymap.set('n', '<leader>wa', '<cmd>AutoSession toggle<CR>', { desc = '[W]orkspace toggle [A]utosave' })
  end,
}
